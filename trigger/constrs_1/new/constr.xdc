...
#create_clock  -name sys_clk_pin -period 8.000 -waveform {0.000 4.000} [get_ports  sys_clock ]


## BUTTONS ##
set_property  PACKAGE_PIN D20  [get_ports  reset_rtl ]
set_property  PACKAGE_PIN D19  [get_ports  LOAD_0 ]
set_property  IOSTANDARD LVCMOS33  [get_ports  reset_rtl ]
set_property  IOSTANDARD LVCMOS33  [get_ports  LOAD_0 ]


## DIODS PROPERTIES ##
set_property  PACKAGE_PIN N15  [get_ports  trigger_0 ]     
set_property  IOSTANDARD LVCMOS33  [get_ports  trigger_0 ] 
#set_property  PACKAGE_PIN G17  [get_ports  led_out_0[1]]     
...
#set_property  PACKAGE_PIN M15  [get_ports  led_out_0[0] ]       
#set_property  IOSTANDARD LVCMOS33  [get_ports  led_out_0[0] ]   
#set_property  PACKAGE_PIN L14  [get_ports  led_out_0[0] ]     
#set_property  IOSTANDARD LVCMOS33  [get_ports  led_out_0[0] ]  
#set_property  PACKAGE_PIN G14  [get_ports  led_out_0[0] ]   
#set_property  IOSTANDARD LVCMOS33  [get_ports  led_out_0[0] ]  
...
#set_property  PACKAGE_PIN U18  [get_ports  clk_out_ch2_1 ]; #IO_L12P_T1_MRCC_34 Sch=ja_p[3]      # ja[4]
#set_property PACKAGE_PIN U19  [get_ports  ja[5] ]; #IO_L12N_T1_MRCC_34 Sch=ja_n[3]     # ja[5]
#set_property  PACKAGE_PIN W18  [get_ports  clk_out_ch3_1 ]; #IO_L22P_T3_34 Sch=ja_p[4]           # ja[6]
...
## Pmod Header JB
#set_property PACKAGE_PIN W14  [get_ports  clk_out_ch2_0 ]; #IO_L8P_T1_34 Sch=jb_p[1]          jb[0]
#set_property PACKAGE_PIN Y14  [get_ports  clk_lvds_n ]; #IO_L8N_T1_34 Sch=jb_n[1]          jb[1]
#set_property PACKAGE_PIN T11  [get_ports  clk_out_ch2_0  ]; #IO_L1P_T0_34 Sch=jb_p[2]          jb[2]
...
## IOSTANDARD YYYYXXXX
#set_property IOSTANDARD LVCMOS33 [get_ports  clk_out_ch2_0];   # jb[0]
